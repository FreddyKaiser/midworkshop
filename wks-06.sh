#!/bin/sh
#
# Workshop script to decode the mss:MSS_Signature and display the user certificate
# Parameters are <mss:Base64Signature>
...
if [ "$SIGNATURE" = "" ]; then	
# Nothing passed, set default one		
